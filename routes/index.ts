...
import HappyNorming from '../functions/HappyNorming';
import FunnyAnimals from '../functions/FunnyAnimals';
import RMSHandler from '../functions/RMSHandler';
import Parser from '../functions/Parser';
import YaSearch from '../functions/YaSearch/index';
import ReqResHandler from '../engine/ReqResHandler';
...
router.get('/rms-handler/', async (req, res) => {
  await new ReqResHandler(req, res, async (req, res) => {
    res.send(
